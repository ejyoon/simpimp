...
Overall, results in Experiment 3 found more pronounced developmental gains in both accuracy and speed of ad-hoc implicature processing. All age groups responded correctly to control trials well above chance, and all but two-year-olds responded correctly to inference trials (see Figure 3). Accuracy increased and reaction times decreased with age, indicating that children become more skilled at implicature computation as they get older. Even 3-year-olds computed implicatures and chose the inferential target above chance ($t$(`r expt3.ttest.acc.3y.df`) = `r expt3.ttest.acc.3y.t`, $p$ =`r expt3.ttest.acc.3y.p`). 2-year-olds' performance did not differ from chance ($t$(`r expt3.ttest.acc.2y.df`) = `r expt3.ttest.acc.2y.t`, $p$ =`r expt3.ttest.acc.2y.p`)

A linear mixed-effects model predicting accuracy based on age, trial type and number of features present showed a significant negative interaction of inference trial and 3-vs-1 ($\beta$ = `r expt3.acc.int1.beta`, $p <.05$), indicating that performances on 3-vs-1 inference trials were poorer. This is in line with our initial predictions, namely that younger children were expected to have more difficulty processing implicature when they need to inhibit responding to the greater perceptual salience of the distractor. 
