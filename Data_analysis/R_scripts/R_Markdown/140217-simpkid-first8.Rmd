...
# there is a weird default for the eye-tracker such that when you are not looking, the coordinates recorded is (0,1050). So get rid of these default coordinates.
...
subject.nas <- ddply(d,c("subid","count.na"),"nrow")
print(subject.nas)
...
***Add rejection of trial-by-trial***
